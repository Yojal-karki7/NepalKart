  ...
  return (
    <form onSubmit={handleSubmit} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className="w-full">
        ...
        <input onChange={(e)=>setName(e.target.value)} value={name} className='w-full maxw-[500px] px-3 py-2' type="text" placeholder='Type here' required />
      </div>
      <div className="w-full">
        <p className='mb-2'>Product description</p>
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full maxw-[500px] px-3 py-2' type="" placeholder='Write content here' required />
      </div>
      ...
      <div className="">
        <p className='mb-2'>Procudt Price</p>
